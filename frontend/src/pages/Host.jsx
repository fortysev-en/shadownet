					...
					<TabsContent value="disclaimer" className="w-full">
						<div className="w-full min-h-[70vh] flex flex-col items-center justify-center gap-6">
							...
							<p className="lg:w-3/6 w-full text-center leading-8 text-muted-foreground">
								This application is intended solely for educational purposes and
								is to be used exclusively on devices owned by the user. The
								developers and the &apos;fortyseven&apos; do not endorse or
								encourage hacking or any other illegal activities. Users are
								fully responsible for their actions, and any misuse of this
								application for illegal purposes is strictly prohibited. The
								developers and &apos;fortyseven&apos; disclaim all liability for
								any legal consequences resulting from the improper use of this
								application. Please use it responsibly and in accordance with
								all applicable laws.
							</p>
						</div>
					</TabsContent>
